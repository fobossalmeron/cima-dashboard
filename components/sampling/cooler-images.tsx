...
import { CoolerImageData } from './sampling.types'

/**
 * Componente que muestra una galería de imágenes de coolers en puntos de venta.
 *
 * @param {CoolerImageData[]} props.data
 * @property {string} url - URL de AWS de la imagen (ej. "https://s3.amazonaws.com/bucket-name/image-name.jpg")
 * @property {string} name - Nombre o descripción del cooler
 */
...
export function CoolerImages({ data }: { data: CoolerImageData[] }) {
  ...
  return (
    <Card className="h-full">
      <CardHeader>
        <CardTitle>Coolers - Imágenes de coolers</CardTitle>
      </CardHeader>
      <CardContent>
