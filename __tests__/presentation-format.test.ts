import { PresentationFormatService } from '@/lib/services/presentation-format.service'

describe('PresentationFormatService', () => {
  describe('getPresentationName', () => {
    it('debe extraer correctamente el nombre de la presentación para latas (CAN)', () => {
      ...
      const result = PresentationFormatService.getPresentationName(
        questionName,
        brandName,
      )
